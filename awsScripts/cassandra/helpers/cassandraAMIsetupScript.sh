...
echo "installing DSE Cassandra" > /home/ubuntu/instanceStatus
sudo su - cassandra
cd /home/cassandra
curl --user blissrj@familysearch.org:CosyBug12 -L http://downloads.datastax.com/enterprise/dse-5.0.4-bin.tar.gz > dse.tar.gz
tar xzvf dse.tar.gz
dsedir=`ls | grep dse-`
ln -s /home/cassandra/$dsedir dse

echo "installing OpsCenter" > /home/ubuntu/instanceStatus
curl --user blissrj@familysearch.org:CosyBug12 -L http://downloads.datastax.com/enterprise/opscenter-6.0.4.tar.gz > opscenter.tar.gz
tar xzvf opscenter.tar.gz
opsdir=`ls | grep opscenter-`
ln -s /home/cassandra/$opsdir opscenter

echo "installing Datastax Agent" > /home/ubuntu/instanceStatus
curl --user blissrj@familysearch.org:CosyBug12 -L http://downloads.datastax.com/enterprise/datastax-agent-6.0.4.tar.gz > datastax-agent.tar.gz
tar xzvf datastax-agent.tar.gz
agentdir=`ls | grep datastax-agent-`
ln -s /home/cassandra/$agentdir datastax-agent
...
export CASSANDRA_HOME=/home/cassandra/dse
